...
class DashboardView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.user.is_superuser:
            context['lunches'] = LunchEvent.objects.all().order_by('-date_modified')
            ...
            context['lunches'] = LunchEvent.objects.with_person(self.request.user.person).order_by('-date_modified')
        context['groceries'] = GroceryEvent.objects.all().order_by('-date_modified')
        return context
